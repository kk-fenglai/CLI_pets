...
export function buildSessionInstructions(): string {
  ...
  const spotlight =
    getPresentationMode(soul) === 'spotlight' ? ['', buildSpotlightRules(soul, bones), ''] : []
...
export function companionSessionPromptDescription(): string {
